#include <SDL2/SDL.h>
#include <SDL2/SDL_ttf.h> // For text rendering (menus)
#include <iostream>
#include <fstream>
#include <vector>
#include <string>
...
int main(int argc, char* argv[]) {
    ...
    SDL_Window* window = SDL_CreateWindow("SDL2 File Loader", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 800, 600, SDL_WINDOW_SHOWN); // SDL2 window creation flag
    ...
    while (running) {
        ...
        while (SDL_PollEvent(&event)) {
            switch (event.type) {
                case SDL_QUIT: // SDL_QUIT for SDL2
                    running = false;
                    break;
                case SDL_KEYDOWN: // SDL_KEYDOWN for SDL2
